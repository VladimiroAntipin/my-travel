...
const SearchModal = () => {
    ...
    let bodyContent = (
        <div className="flex flex-col gap-8">
            <Heading title="Where do you want to go?" subtitle="Find the perfect location for you"/>
    ...
    if(step === STEPS.DATE) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="When would you like to go?" subtitle="Select the date of your journey"/>
    ...
    if(step === STEPS.INFO) {
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading title="More informations" subtitle="Find the place you like more"/>
